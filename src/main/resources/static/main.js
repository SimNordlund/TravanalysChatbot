  ...
  result.innerHTML = '<h2>Resultat på analys</h2><div id="result-content">' + text.replace(
  /\n/g, '<br>') + '</div>';
} catch (error) {
  result.innerHTML = '<div class="loading-text">Error: ' + error.message + '</div>';
}
});
  ...
  appendMessage("Halloj! Jag är ditt bollplank för amorteringsfrågor. Hur kan jag hjälpa dig idag?",
  "bot");
